        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                 <a href="{{ URL::to('/admin/product/create')}}" class="btn btn-primary">
                                ...
                                <td class="text-center">
                                    <form method="POST"  action="{{ URL::to('/admin/product/'.$product['id']) }}">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="submit" onclick="return confirm('Ingin menghapus data ini?')" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                        </div>
                                    </form>
                                </td>
                            </tr>
